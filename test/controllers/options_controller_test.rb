...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { input: @option.input, setting_id: @option.setting_id } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { input: @option.input, setting_id: @option.setting_id } }
